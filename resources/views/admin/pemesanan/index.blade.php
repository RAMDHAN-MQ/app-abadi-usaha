            ...
            <tr>
                ...
                <td class="text-center">
                    <form action="{{ route('admin.pemesanan.destroy', $item->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <a href="{{ route('admin.pemesanan.edit', $item->id) }}" class="btn btn-warning btn-sm"><i class="bi bi-pencil"></i></a>
                        <button type="button" class="btn btn-danger btn-sm btn-delete"><i class="bi bi-trash"></i></button>
                        <a href="{{ route('admin.pemesanan.show', $item->id) }}" class="btn btn-primary btn-sm"><i class="bi bi-eye"></i></a>
                        <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#pilihPetugas"><i class="bi bi-person-fill-up"></i></button>
                    </form>
                </td>
            </tr>
            @endforeach
